...
class _SignInState extends State<SignInScreen> {
  ...
  void signIn(BuildContext context) async {
    ...
    if (form.validate()) {
      form.save();
      var _user = await user.getCurrentUser();
      if (_user != null && widget.isLoggedInButNotVerified) {
        await user.signOut();
        setState(() {});
      }
  ...
  void resendVerificationEmail() async {
    ...
    try {
      if (!_user.isEmailVerified) await _user.sendEmailVerification();
    } catch (e) {
      print(e.message);
    }
    try {
                      ...
                      new ClipPath(
                        ...
                        child: Container(
                          ...
                          padding: EdgeInsets.only(
                              top: 150.0,
                              bottom: widget.isLoggedInButNotVerified
                                  ? 40.0
                                  : 75.0),
                          child: Column(
                            children: <Widget>[
